...
const Treatment = () => {
    return (
        <div className=" flex sm:flex-row flex-col p-5  bg-base-100 shadow-xl mx-auto mt-5  ">
            <figure><img className='w-72 lg:w-96 ml-28 my-20  rounded-md' src={treatment} alt="Movie" /></figure>
